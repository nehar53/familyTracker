...
import com.example.gpstracker.FriendRequestActivity;
import com.example.gpstracker.R;


public class NotificationHelper extends ContextWrapper {

    private static final String XYZ_CHANNEL_ID="com.example.gpstracker";
    private static final String XYZ_CHANNEL_NAME="gpstracker";
